...
//						String y="",z="";
//						String x = message.substring(0,8);
//						if(x=="FETCHKEY")
//						{
//							 y = message.substring(9,10);
//							 z = message.substring(10,sentence.length()+1);
//							 if(y=="@")
//							 {
//								  username = z;
...
//													 key_rec = sentence.getBytes();


//							 }
//							 else{
//								 System.out.println("Please Fetch PublicKey Properly");
//								 continue;
//							 }
//							 continue;
//						}
	...
	public void run(){
		...
		while(true) {
			...
			if(ch==0){
        		...
        		CryptographyExample cryptObject = new CryptographyExample();
				byte[] decryptedData = cryptObject.decrypt(privateKey,Base64.getDecoder().decode(Message)); //doubt
